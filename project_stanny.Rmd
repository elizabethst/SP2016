...
+ Pick a company in the S&P 500 (not ExxonMobil) from the list posted [here](https://en.wikipedia.org/wiki/List_of_S%26P_500_companies) that has Non-Controlling Interest.
...
df <- 
  ...
  mutate(NCI_m = NCI/1000000, ExxonMobil_Equity_m = ExxonMobil_Equity/1000000) %>%
